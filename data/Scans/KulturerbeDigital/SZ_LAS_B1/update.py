...
base_dir = r'C:\Users\pollin\Documents\GitHub\SZD\data\Scans\KulturerbeDigital\SZ_LAS_B1'
id_counter = 3650
...
def add_idno_to_xml(file_path, id_value):
    try:
        ...
        contributor_element = ET.Element(f'{{{ns[""]}}}contributor')
        contributor_element.text = f'Masereel, Frans'

        # Append the new <idno> element to the root element
        root.append(idno_element)
        root.append(contributor_element)
