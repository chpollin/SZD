        ...
        <xsl:choose>
            ...
            <xsl:when test="$mode = 'miscellaneous'">
                <article class="card">
                    ...
                    <div class="card-body">
                        <hr/>
                        <xsl:apply-templates select="document(concat('/context:szd/', 'MISCELLANEOUS'))/t:TEI/t:text/t:body/t:div"/>
                    </div>
                </article>
            </xsl:when>
            <!-- //////////////////////////////////////////////////////////// -->
                    ...
                    <article>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!--  -->
                                <div class="m-5">
                                    <img src="/archive/objects/context:szd/datastreams/STARTBILD_TITLE/content" class="img-fluid" alt="STARTBILD_TITLE"/>
                                </div>
                                <!--  -->
                                 <div class="mt-5">
